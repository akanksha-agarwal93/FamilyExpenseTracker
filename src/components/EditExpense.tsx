        ...
        <div>
            ...
            <div className="flex-1 flex-row">
                <label className="mr-2">Expense Name:</label>
                    <input type="text" id="expense-name" className="bg-gray-100" value={expenseName}
                        onChange={(e) => setExpenseName(e.target.value)} />
            </div>
            <div className="flex-1 flex-row">
                <label className="mr-2 mt-5">Expense Category:</label>
                    <input type="text" id="expense-category" className="bg-gray-100" value={expenseCategory}
                        onChange={(e) => setExpenseCategory(e.target.value)} />
            </div>
            <div className="flex-1 flex-row">
                <label className="mr-2 mt-5">Expense amount:</label>
                    <input type="number" id="expense-amount" className="bg-gray-100" value={expenseAmount}
